...
namespace Schnorr
{
    public class SchorrForm : Form
    {
        ...
        private void ApplyTheme(bool dark)
        {
            ...
            if (verificationResultLabel != null && saved.resultText != null)
            {
                ...
                else
                {
                    ...
                    {
                        banner.FillColor = verificationResultLabel.BackColor;
                        banner.BorderColor = verificationResultLabel.BackColor;
                    }
                }
            }
        ...
        private TableLayoutPanel MakeTabLayout(int rowCount = 3)
        {
